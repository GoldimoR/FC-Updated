...
RastaTinker.optionTinkerEnable = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker"}, "Enable", false)
RastaTinker.optionTinkerComboKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Tinker"}, "Combo Key", Enum.ButtonCode.KEY_Z)
RastaTinker.optionTinkerSpamKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Tinker"}, "Spam Rockets Key", Enum.ButtonCode.KEY_F)
RastaTinker.optionTinkerFailSwitch = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker"}, "Rocket and Rearm failswitch", true)
RastaTinker.optionTinkerSoulRearm = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker"}, "Auto use soulring before rearm", true)
RastaTinker.optionTinkerPoopLaser = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker"}, "Poop Linken with Laser", false)
RastaTinker.optionTinkerTargetStyle = Menu.AddOptionCombo({"Hero by Rasta", "Hero Specific", "Tinker"}, "Target Style", {"Free Target", "Lock Target"}, 1)
RastaTinker.optionTinkerCheckBM = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker"}, "Check BM/Lotus", true)
RastaTinker.optionTinkerEnableLaser = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Skills"}, "Laser", true)
RastaTinker.optionTinkerEnableRockets = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Skills"}, "Heat-Seeking Missle", true)
RastaTinker.optionTinkerEnableRearm = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Skills"}, "Rearm", true)
RastaTinker.optionTinkerEnableBkb = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Black King Bar", false)
RastaTinker.optionTinkerEnableBlink = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Blink Dagger", false)
RastaTinker.optionTinkerBlinkSafeRange = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Safe Radius for Blink", 0, 800, 400)
RastaTinker.optionTinkerBlinkStyle = Menu.AddOptionCombo({"Hero by Rasta", "Hero Specific", "Tinker"}, "Blink Style", {"Auto Blink Safe Pozition", "Cursor Position"}, 0)
RastaTinker.optionTinkerEnableBlood = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Bloodthorn", false)
RastaTinker.optionTinkerEnableDagon = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Dagon", false)
RastaTinker.optionTinkerEnableEblade = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Ethereal Blade", false)
RastaTinker.optionTinkerEnableLotus = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Lotus Orb", false)
RastaTinker.optionTinkerEnableOrchid = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Orchid", false)
RastaTinker.optionTinkerEnableHex = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Scythe of Vyse", false)
RastaTinker.optionTinkerEnableShiva = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Shiva's Guard", false)
RastaTinker.optionTinkerEnableSoul = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Soul Ring", false)
RastaTinker.optionTinkerThreshold = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "HP Percent Threshold for use soulring", 0, 99, 10)
RastaTinker.optionTinkerEnableDiscord = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Tinker", "Items"}, "Veil of Discord", false)
RastaTinker.optionEnablePoopLinken = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Enable", false)
RastaTinker.optionEnablePoopAbyssal = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Abyssal Blade", false)
RastaTinker.optionEnablePoopBlood = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Bloodthorn", false)
RastaTinker.optionEnablePoopDagon = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Dagon", false)
RastaTinker.optionEnablePoopDiffusal = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Diffusal Blade", false)
RastaTinker.optionEnablePoopEul = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Eul", false)
RastaTinker.optionEnablePoopForce = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Force Staff", false)
RastaTinker.optionEnablePoopHalberd = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Heavens Halberd", false)
RastaTinker.optionEnablePoopHex = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Hex", false)
RastaTinker.optionEnablePoopPike = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Hurricane Pike", false)
RastaTinker.optionEnablePoopOrchid = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Orchid", false)
...
function RastaTinker.TinkerNeedRearm( ... )
	...
	if bloodthorn and Menu.IsEnabled(RastaTinker.optionTinkerEnableBlood) and Ability.IsCastable(bloodthorn, myMana) then
		bool = false
	end
...
function RastaTinker.PoopLinken(exception)
	...
	if bloodthorn and Menu.IsEnabled(RastaTinker.optionEnablePoopBlood) and Ability.IsCastable(bloodthorn, myMana) then
		Ability.CastTarget(bloodthorn, enemy)
		return
	end
