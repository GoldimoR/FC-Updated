...
local optionKillSteal = Menu.AddOption({"Hero by Rasta", "Earthshaker","Skills"}, "Kill Steal", "Auto cast Breathe fire")
local Addskill1 = Menu.AddOption({"Hero by Rasta", "Earthshaker","Skills"}, "Fissure","Enable Skill")
local Addskill2 = Menu.AddOption({"Hero by Rasta", "Earthshaker","Skills"},"Enchant Totem","Enable Skill")
local Addskill3 = Menu.AddOption({"Hero by Rasta", "Earthshaker Knigth","Skills"},"Echo Slam","Enable Skill")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Earthshaker", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Earthshaker", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Hurricane Pike", "if target in radius 400")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "BKB", "if target in radius 800")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Blade Mail", "if target in radius 800")
local Addblink = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Scythe of Vyse","Use item on combo")
local Addurna = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Soul Ring","Use item on combo")
local Addspirit = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Earthshaker", "Items" }, "Eul","Use item on combo")
...
function Earthshaker.OnUpdate()
	...
	if Menu.IsKeyDown(Earthshaker.PressComboKey) then	
		...
		if Menu.IsEnabled(Addskill3) and enemyTarget and ulti and Ability.IsReady(ulti) and Ability.IsCastable(ulti, myMana) then
       ...
       if Menu.IsEnabled (Addspirit) and spiritvessel and enemyTarget and Ability.IsReady(spiritvessel) and Ability.IsCastable(spiritvessel, myMana) then
		...
		if Menu.IsEnabled(Addskill1) and enemyTarget and fissure and Ability.IsReady(fissure) and Ability.IsCastable(fissure, myMana) then
			local enemyAbsOrigin = Entity.GetAbsOrigin(enemyTarget)
...
function Earthshaker.Ethereal(myHero)
