...
local Addskill1 = Menu.AddOption({"Hero by Rasta", "Chaos Knigth","Skills"}, "Chaos Bolt","Enable Skill")
local Addskill2 = Menu.AddOption({"Hero by Rasta", "Chaos Knigth","Skills"},"Reality Rift","Enable Skill")
local Addskill3 = Menu.AddOption({"Hero by Rasta", "Chaos Knigth","Skills"},"Phantasm","Enable Skill")
local optionKillSteal = Menu.AddOption({"Hero by Rasta", "Chaos Knigth","Skills"}, "Kill Steal", "Auto cast RiFt")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Chaos Knigth", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Chaos Knigth", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Hurricane Pike", "if target in radius 400")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "BKB", "if target in radius 800")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Blade Mail", "if target in radius 800")
local Addblink = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Scythe of Vyse","Use item on combo")
local Addurna = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Soul Ring","Use item on combo")
local Addspirit = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Chaos Knigth", "Items" }, "Eul","Use item on combo")
...
function chaos.OnUpdate()
	...
	if Menu.IsKeyDown(chaos.PressComboKey) then	
		...
		if Menu.IsEnabled(Addskill3) and enemyTarget and phantasm and Ability.IsReady(phantasm) and Ability.IsCastable(phantasm, myMana) then
			Ability.CastNoTarget(phantasm)
		end
		
		if Menu.IsEnabled(Addskill2) and enemyTarget and rift and Ability.IsReady(rift) and Ability.IsCastable(rift, myMana) then
			Ability.CastTarget(rift, enemyTarget)
		end
...
function chaos.Ethereal(myHero)
