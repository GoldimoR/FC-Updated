...
local optionEnableScript = Menu.AddOption({"Hero by Rasta", "Bloodseeker"}, "1.Enable", "Turn on/off this script.")
local PressComboKey = Menu.AddKeyOption({ "Hero by Rasta","Bloodseeker" }, "2. Execute combo key", Enum.ButtonCode.KEY_I)
local Addabillity1 = Menu.AddOption({"Hero by Rasta", "Bloodseeker","Skills"}, "Bloodrage","Enable Skill")
local Addabillity2 = Menu.AddOption({"Hero by Rasta", "Bloodseeker","Skills"}, "Blood Bath","Enable Skill")
local Addabillity3 = Menu.AddOption({"Hero by Rasta", "Bloodseeker","Skills"}, "Rupture","Enable Skill")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Bloodseeker", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Bloodseeker", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" },"Hurricane", "Hurricane Pike if target in radius 400")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "BKB", "if target in radius 800")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Blade Mail", "if target in radius 800")
local Addblink = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Scythe of Vyse","Use item on combo")
--local Addurna = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Soul Ring","Use item on combo")
--local Addspirit = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Bloodseeker", "Items" }, "Eul","Use item on combo")
...
--		local spiritvessel = NPC.GetItem(myHero,"item_spirit_vessel", true) 
		...
		if Menu.IsEnabled(Addabillity1) and enemyTarget and Rupture and Ability.IsReady(Rupture) and Ability.IsCastable(Rupture, myMana) then
			Ability.CastTarget(Rupture, enemyTarget) 
		end
		
		if Menu.IsEnabled(Addabillity2) and enemyTarget and Bloodrage and Ability.IsReady(Bloodrage) and Ability.IsCastable(Bloodrage, myMana) then
...
--		end
		...
		if Menu.IsEnabled(Addabillity3) and BloodRite and Ability.IsCastable(BloodRite, myMana) and enemyTarget ~= nil and NPC.IsPositionInRange(myHero, Entity.GetAbsOrigin(enemyTarget),1200,0) then 
		local enemyAbsOrigin = Entity.GetAbsOrigin(enemyTarget)
...
function Blood.Ethereal(myHero)
