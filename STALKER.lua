...
local Addskill1 = Menu.AddOption({"Hero by Rasta", "Balanar","Skills"},"Void","Enable Skill")
local Addskill2 = Menu.AddOption({"Hero by Rasta", "Balanar","Skills"}, "Crippling Fear","Enable Skill")
local Addskill3 = Menu.AddOption({"Hero by Rasta", "Balanar","Skills"},"Hunter in the Night","Enable Skill")
local Addskill4 = Menu.AddOption({"Hero by Rasta", "Balanar","Skills"}, "Darkness","Enable Skill")
local optionKillSteal = Menu.AddOption({"Hero by Rasta", "Balanar","Skills"}, "Kill Steal", "Auto cast Edge")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Balanar", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Balanar", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Hurricane Pike if target in radius 400","Use item on combo")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "BKB if target in radius 800","Use item on combo")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Blade Mail if target in radius 800","Use item on combo")
local Addblink = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Scythe of Vyse","Use item on combo")
local Addurna = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Soul Ring","Use item on combo")
local Addspirit = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Balanar", "Items" }, "Eul","Use item on combo")
...
function balanar.OnUpdate()
	...
	if Menu.IsKeyDown(balanar.PressComboKey) then	
		...
		if Menu.IsEnabled(Addskill4) and enemyTarget and darkness and Ability.IsReady(darkness) and Ability.IsCastable(darkness, myMana) then 
			Ability.CastNoTarget(darkness) 
		end
		
		if Menu.IsEnabled(Addskill3) and enemyTarget and hunter and Ability.IsReady(hunter) and Ability.IsCastable(hunter, myMana) then 
			Ability.CastNoTarget(hunter) 
		end
		
		if Menu.IsEnabled(Addskill2) and enemyTarget and fear and Ability.IsReady(fear) and Ability.IsCastable(fear, myMana) then 
			Ability.CastTarget(fear, enemyTarget) 
		end
		
		if Menu.IsEnabled(Addskill1) and enemyTarget and void and Ability.IsReady(void) and Ability.IsCastable(void, myMana) then 
