...
local optionKillSteal = Menu.AddOption({"Hero by Rasta", "Spirit Breaker","Skills"}, "Kill Steal", "Auto cast Nether Strike")
local Addskill1 = Menu.AddOption({"Hero by Rasta", "Spirit Breaker","Skills"},"Charge of Darkness","Enable Skill")
local Addskill2 = Menu.AddOption({"Hero by Rasta", "Spirit Breaker","Skills"}, "Empowering Haste","Enable Skill")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Spirit Breaker", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Spirit Breaker", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Hurricane Pike if target in radius 400","Use item on combo")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "BKB if target in radius 800","Use item on combo")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Blade Mail if target in radius 800","Use item on combo")
local Addblink = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Scythe of Vyse","Use item on combo")
local Addurna = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Soul Ring","Use item on combo")
local Addspirit = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Spirit Breaker", "Items" }, "Eul","Use item on combo")
...
function Bara.OnUpdate()
	...
	if Menu.IsKeyDown(Bara.PressComboKey) then	
		...
		if Menu.IsEnabled(Addskill1) and enemyTarget and charge and Ability.IsReady(charge) and Ability.IsCastable(charge, myMana) then
			Ability.CastTarget(charge, enemyTarget) 
		end
		
		if Menu.IsEnabled(Addskill2) and enemyTarget and haste and Ability.IsReady(haste) and Ability.IsCastable(haste, myMana) then
...
function Bara.KillSteal(myHero)
	...
	local truedmg = NPC.GetTrueDamage(myHero)
    local damage = Ability.GetDamage(edge) + truedmg
    local range = 670
    ...
    for i, enemy in ipairs(enemies) do
    	...
    	local true_damage = damage * NPC.GetArmorDamageMultiplier(enemy) - enemyHPregen 
