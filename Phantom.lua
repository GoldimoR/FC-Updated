...
local Addskill1 = Menu.AddOption({"Hero by Rasta", "Phantom","Skills"}, "Stifling Dagger","Enable Skill")
local Addskill2 = Menu.AddOption({"Hero by Rasta", "Phantom","Skills"},"Phantom Strike","Enable Skill")
local optionKillSteal = Menu.AddOption({"Hero by Rasta", "Phantom","Skills"}, "Kill Steal", "Auto cast Dagger")
local optionAutoDagger = Menu.AddOption({"Hero by Rasta", "Phantom","Skills"}, "Auto Dagger", "Auto Dagger if hero in radius")
local Addethereal = Menu.AddOptionCombo({"Hero by Rasta", "Phantom", "Items" }, "Ethereal Blade", {"Use in Combo", "Just Kill Steal"}, 1)
local AddSatanic = Menu.AddOptionSlider({"Hero by Rasta", "Phantom", "Items", "Auto Satanic"}, "hp for acrivation", 400, 2000, 1000)
local Addhurricanepike = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Hurricane Pike", "if target in radius 400")
local AddBKB = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "BKB", "if target in radius 800")
local Addblademail = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Blade Mail", "if target in radius 800")
local Addblink = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Blink","Use item on combo")
local Addskythe = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Scythe of Vyse","Use item on combo")
local Addurna = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Urn of Shadows","Use item on combo")
local Addsoulring = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Soul Ring","Use item on combo")
local Addspirit = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Spirit Vessel","Use item on combo")
local Addpipe = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Pipe of Insigth","Use item on combo")
local Addcrimpson = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Crimson Guard","Use item on combo")
local Addhalebard = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Heavens Halberd","Use item on combo")
local Addshivas = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Shivas Guard","Use item on combo")
local Addmjollnir = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Mjollnir","Use item on combo")
local Addatos = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Rod of Atos","Use item on combo")
local AddMoM = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Mask of Madnes","Use item on combo")
local Addnecronomicon = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Necronomicon","Use item on combo")
local Addveilofdiscord = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Veil of Discord","Use item on combo")
local Addlotusorb = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Lotus Orb","Use item on combo")
local Addmanta = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Manta Style","Use item on combo")
local Adddiffusalblade = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Diffusal Blade","Use item on combo")
local Addnullifier = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Nullifier","Use item on combo")
local Addmedallion = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Medallion of Courage","Use item on combo")
local Addsolarcrest = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Solar Crest","Use item on combo")
local Addorchid = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Orchid","Use item on combo")
local Addbloodthorn = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Bloodthorn","Use item on combo")
local Addabyssalblade = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Abyssal Blade","Use item on combo")
local Addforcestaff = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Force Staff","Use item on combo")
local Addeul = Menu.AddOption({"Hero by Rasta", "Phantom", "Items" }, "Eul","Use item on combo")
...
function Phantom.OnUpdate()
    ...
    return
		...
		if Menu.IsEnabled(Addskill1) and enemyTarget and dagger and Ability.IsReady(dagger) and Ability.IsCastable(dagger, myMana) then
			Ability.CastTarget(dagger, enemyTarget)
		return end
		
		if Menu.IsEnabled(Addskill2) and enemyTarget and strike and Ability.IsReady(strike) and Ability.IsCastable(strike, myMana) then 
...
function Phantom.Ethereal(myHero)
