...
local arcPushMode = Config.ReadString("Hero by Rasta", "arcPushMode", "Auto")
local arcPushModeLine = Config.ReadString("Hero by Rasta", "arcPushModeLine", "min")
local necroTable = {}
local mantaTable = {}
...
RastaArc.optionArcEnable = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Enable", false)
RastaArc.optionArcMainComboKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Main Hero Combo Key", Enum.ButtonCode.KEY_Z)
RastaArc.optionArcCloneComboKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Clone Combo Key", Enum.ButtonCode.KEY_V)
RastaArc.optionArcStackClone = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Use Clone in Main Hero Combo", true)	
RastaArc.optionArcTargetStyle = Menu.AddOptionCombo({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Target Style", {"Lock Target", "Free Target"}, 0)
RastaArc.optionArcDebuffUnstack = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Debuff Unstack", true)
RastaArc.optionArcClonePushKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Clone Push Key", Enum.ButtonCode.KEY_N)
RastaArc.optionArcMinimumRangeToTP = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Minimum Range to use travel boots in push mode", 1000,3000,1000)
RastaArc.optionArcDrawPanel = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Draw Info Panel", true)
RastaArc.optionArcPanelMoveable = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Movable Panel", true)
RastaArc.optionArcEnableFlux = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Skills"}, "Flux", true)
RastaArc.optionArcEnableField = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Skills"}, "Magnetic Field", true)
RastaArc.optionArcEnableSpark = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Skills"}, "Spark Wraith", true)
RastaArc.optionArcSpamSparkKey = Menu.AddKeyOption({"Hero by Rasta", "Hero Specific", "Arc Warden"}, "Spam Spark Wraith Key", Enum.ButtonCode.KEY_T)
RastaArc.optionDoubleFieldMode = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Double Magnetic Field Mode"}, "Enable", false)
RastaArc.optionSharedPointRadius = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Arc Warden", "Double Magnetic Field Mode"}, "Shared Point Radius", 0, 100, 10)
RastaArc.optionDoubleFieldModeMinimumHeroes = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Arc Warden", "Double Magnetic Field Mode"}, "Minimum Heroes to use double field", 1, 5, 2)
RastaArc.optionArcEnableBkb = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Black King Bar", false)
RastaArc.optionArcEnableBlood = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific","Arc Warden", "Items"}, "Bloodthorn", false)
RastaArc.optionArcEnableDiffusal = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Diffusal Blade", false)
RastaArc.optionArcEnableMidas = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Hand of Midas", false)
RastaArc.optionArcEnableManta = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Manta Style", false)
RastaArc.optionArcEnableMom = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Mask of Madness")
RastaArc.optionArcEnableMjolnir = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Mjolnir", false)
RastaArc.optionArcEnableNecro = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Necronomicon", false)
RastaArc.optionArcEnableNulifier = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Nullifier", false)
RastaArc.optionArcEnableOrchid = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Orchid", false)
RastaArc.optionArcEnableSatanic = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Satanic", false)
RastaArc.optionArcSatanicThreshold = Menu.AddOptionSlider({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "HP Percent for satanic use", 1, 50, 15)
RastaArc.optionArcEnableHex = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Scythe of Vyse", false)
RastaArc.optionArcEnableSilver = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Silver Edge (Main Hero)", false)
RastaArc.optionArcEnableSilverClone = Menu.AddOptionBool({"Hero by Rasta", "Hero Specific", "Arc Warden", "Items"}, "Silver Edge (Clone)", false)
RastaArc.optionEnablePoopLinken = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Enable", false)
RastaArc.optionEnablePoopAbyssal = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Abyssal Blade", false)
RastaArc.optionEnablePoopBlood = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Bloodthorn", false)
RastaArc.optionEnablePoopDagon = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Dagon", false)
RastaArc.optionEnablePoopDiffusal = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Diffusal Blade", false)
RastaArc.optionEnablePoopEul = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Eul", false)
RastaArc.optionEnablePoopForce = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Force Staff", false)
RastaArc.optionEnablePoopHalberd = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Heavens Halberd", false)
RastaArc.optionEnablePoopHex = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Hex", false)
RastaArc.optionEnablePoopPike = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Hurricane Pike", false)
RastaArc.optionEnablePoopOrchid = Menu.AddOptionBool({"Hero by Rasta", "Poop Linken"}, "Orchid", false)
...
function RastaArc.Init( ... )
	...
	if not myHero then return end
		...
		x = Config.ReadInt("Hero by Rasta", "arcPanelX", w/2)
		y = Config.ReadInt("Hero by Rasta", "arcPanelY", h/2)
		else	
		myHero = nil
		return	
	end
...
function RastaArc.DrawArcPanel( ... )
	...
	if Menu.IsEnabled(RastaArc.optionArcPanelMoveable) then
		if Input.IsKeyDown(Enum.ButtonCode.KEY_UP) then
			y = y - 10
			Config.WriteInt("Hero by Rasta", "arcPanelY", y)
		end
		...
		if Input.IsKeyDown(Enum.ButtonCode.KEY_LEFT) then
			x = x - 10
			Config.WriteInt("Hero by Rasta", "arcPanelX", x)
		end
	...
	if hoveringOverAuto and Input.IsKeyDownOnce(Enum.ButtonCode.MOUSE_LEFT) then
		if arcPushMode == "Cursor" then
			arcPushMode = "Auto"
			Config.WriteString("Hero by Rasta", "arcPushMode", "Auto")
		end
	end
	...
	if hoveringOverCursor and Input.IsKeyDownOnce(Enum.ButtonCode.MOUSE_LEFT) then
		if arcPushMode == "Auto" then
			arcPushMode = "Cursor"
			Config.WriteString("Hero by Rasta", "arcPushMode", "Cursor")
		end
	end
	if arcPushMode == "Auto" then
	...
	if hoveringOverFurthest and Input.IsKeyDownOnce(Enum.ButtonCode.MOUSE_LEFT) then
		if arcPushModeLine == "max" then
			arcPushModeLine = "min"
			Config.WriteString("Hero by Rasta", "arcPushModeLine", "min")
		end
	end
	...
	if hoveringOverLeast and Input.IsKeyDownOnce(Enum.ButtonCode.MOUSE_LEFT) then
		if arcPushModeLine == "min" then
			arcPushModeLine = "max"
			Config.WriteString("Hero by Rasta", "arcPushModeLine", "max")
		end
	end
